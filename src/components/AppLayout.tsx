...
import { KanbanSquare, FolderKanban, Shield, LogOut, User as UserIcon, BarChart3, FileText, ListChecks, Package } from "lucide-react";
...
export function AppLayout({ children }: { children: ReactNode }) {
  ...
  const navItems = [
    ...
    { to: "/templates" as const, label: "Templates", icon: ListChecks },
